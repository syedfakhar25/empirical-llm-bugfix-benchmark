...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help="Idle baseline duration in seconds"
    )
    ...
    try:
        ...
        if (
            ...
            print(
                f"[INFO] Measuring idle baseline for {args.idle_sleep} seconds...",
                file=sys.stderr
            )

            baseline_monitor = GPUEnergyMonitor()
            ...
            baseline_energy = (
                baseline_monitor.energy_joules
            )
        ...
        generation_monitor = GPUEnergyMonitor()
        ...
        measured_energy = (
            generation_monitor.energy_joules
            if NVML_AVAILABLE
            else -1
        )

        final_energy = (
            measured_energy - baseline_energy
